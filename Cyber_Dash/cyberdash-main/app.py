...
from tools.nessus1.routes import nessus1_bp
from tools.nessus2.routes import nessus2_bp
...
app.register_blueprint(nessus1_bp)
app.register_blueprint(nessus2_bp)
